...
import matchTxtByIndex from './components/matchTxtByIndex';
import InputPopup from './InputPopup';
import getOptionText from './components/getTxtOption';
import getOptionLabel from './components/getOptionLabel';
import getOptionValue from './components/getOptionVal';
import isStatic from './components/static';
import DropdownOption from './DropdownOption';
import createStyling from './createStyling';
import getInput from './components/getInput';
import registerInput from './components/registerInput';
import filterByMatchingTextWithThreshold from './filters/filterMatchingTxtwithThreshold';
import filterRedudantSeparators from './filters/filterRedunantSeparators';
import limitBy from './filters/limitBy';
import notFoundMessage from './filters/notFound';
import sortByMatchingText from './filters/sortMatchingText';
...
function getStateFromProps(props) {
  ...
  const match = matchTxtByIndex(value, props.options);
...
export default class Dropdown extends PureComponent {
  ...
  static defaultProps = {
    ...
    optionFilters: [
      filterByMatchingTextWithThreshold(20),
      sortByMatchingText,
      limitBy(100),
      notFoundMessage('No matches found'),
      filterRedudantSeparators
    ]
  };
  ...
  updateHighlightedIndex(value, options, optionFilters) {
    ...
    const match = matchTxtByIndex(value, shownOptions, true);
